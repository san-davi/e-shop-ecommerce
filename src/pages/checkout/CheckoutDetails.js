...
import { SAVE_BILLING_ADDRESS, SAVE_SHIPPING_ADDRESS } from '../../redux/FeaturesOrSlice/checkoutSlice'
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    <Card cardClass={styles.card}>
                        ...
                        <input type="text" placeholder='Recipitent Name' required name='name' value={shippingAddress.name} onChange={(e)=> handleShipping(e)}/>

                        <label>Address Line1</label>
                        <input type="text" placeholder='Address Line1' required name='line1' value={shippingAddress.line1} onChange={(e)=> handleShipping(e)}/>

                        <label>Address Line2</label>
                        <input type="text" placeholder='Address Line2' name='line2' value={shippingAddress.line2} onChange={(e)=> handleShipping(e)}/>
                        ...
                        <label>Country</label>
                        <CountryDropdown valueType='short' className={styles.select} value={shippingAddress.country} onChange={(val)=>handleShipping({
                            target: {
                                name: "country",
                                value: val,
                            }
                    ...
                    <Card cardClass={styles.card}>
                        ...
                        <label>Recipient Name</label>
                        <input type="text" placeholder='Name' requires name='name' value={billingAddress.name} onChange={(e)=> handleBilling(e)}/>

                        <label>Address Line1</label>
                        <input type="text" placeholder='Address Line1' required name='line1' value={billingAddress.line1} onChange={(e)=> handleBilling(e)}/>

                        <label>Address Line2</label>
                        <input type="text" placeholder='Address Line2' name='line2' value={billingAddress.line2} onChange={(e)=> handleBilling(e)}/>
